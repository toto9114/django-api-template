...
class DB(Singleton):
    ...
    @contextmanager
    def get_connection(self, pool=True) -> Generator[MySQLConnection, None, None]:
        conn = (
            self._connection_pool.get_connection()
            if pool
            else MySQLConnection(
    ...
    def get_connection_without_ctx_manager(self, pool=True) -> MySQLConnection:
        conn = (
            self._connection_pool.get_connection()
            if pool
            else MySQLConnection(
